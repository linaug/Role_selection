...
class CoverageEnv(gym.Env, EzPickle):
    ...
    def seed(self, seed=None):
        self.agent_random_state, seed_agents = seeding.np_random(int(self.cfg['seed']))
        self.world_random_state, seed_world = seeding.np_random(int(self.cfg['seed']))
    ...
    def step(self, actions):
        ...
        states, rewards, duplicate_coverage_rewards = {}, {}, {}
        for team_key, team in self.teams.items():
            states[team_key] = []
            rewards[team_key] = {}
